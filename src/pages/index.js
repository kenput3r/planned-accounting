...
const IndexPage = ({ data }) => {
  ...
  return (
    <Layout templateName="index">
      <SEO title="Johnson & Associates CPA" />
      <Page>
        ...
        <div className="color-wrap">
          <div>
            <div className="row wrapper individual-family">
              <div className="col">
                <div className="item">
                  ...
                  <div className="text">
                    ...
                    <p>Get more with your money by maximizing deductions.</p>
                  </div>
                </div>
                <div className="item">
                  <div className="bullet">
                  ...
                  <div className="text">
                    <h4>Tax Return Planning &amp; Filing</h4>
                    <p>
                      Year round do's and don'ts to assist in tax return
                      preperation and assistance filing.
                    </p>
                  </div>
                </div>
                <div className="item">
                  ...
                  <div className="text">
                    ...
                    <p>
                      Stock option planning and consulting. Understand penalties
                      &amp; fees associated with gains.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="item">
                  ...
                  <div className="text">
                    ...
                    <p>
                      Reduce taxable income while saving more for retirement.
                    </p>
                  </div>
                </div>
                <div className="item">
                  ...
                  <div className="text">
                    ...
                    <p>
                      Estate and wealth transfer planning. Prepare for and avoid
                      excess taxation.
                    </p>
                  </div>
                </div>
                <div className="item">
                  ...
                  <div className="text">
                    <h4>Charitable Planning</h4>
                    <p>Learn what kind of giving gives back.</p>
                  </div>
                </div>
              </div>
            </div>
